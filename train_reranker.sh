...
elif [ $reranker_feats == "eolmbert"];then
...
if [ $reranker_feats == "eo" ]; then
    ...
    featstring="EditOps(name='EditOps0'), LM('LM0', '$MODEL_DIR/lm/94Bcclm.trie', normalize=False), WordPenalty(name='WordPenalty0'), BertScore(name='Bert0', '$bert_model', 'albert')"
fi
